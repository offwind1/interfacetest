...
import inter.mizhumanage.web.lesson.LessonReply;
...
public class Lesson {
    ...
    private Lesson(String token, String lessonId) {
        this.token = token;
    ...
    public void applied() {
        apply();
        SampleAssert.assertCode200(LessonReply.of().lessonReplyPass(token, lessonId));
    }
