...
import inter.mizhu.web.course.FileExits;
import inter.mizhu.web.lesson.GetLessonInfoById;
import inter.mizhu.web.lesson.List;
import inter.mizhumanage.web.lesson.AddByFile;
import inter.mizhumanage.web.lesson.LessonUpfile;
    ...
    public void test() throws IOException {
        ...
        for (int i = 0; i < lessonCount; i++) {
            LessonNeedClassroomExcelCreator.Bean lesson = LessonNeedClassroomExcelCreator.Bean.builder()
                    ...
                    .classroomCount(RandomUtil.randomInt(1, 5))
                    .build();
            beans.add(lesson);
        }
