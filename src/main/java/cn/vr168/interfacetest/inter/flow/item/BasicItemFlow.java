package cn.vr168.interfacetest.inter.flow.item;
...
public class BasicItemFlow {
    ...
    public void test() {
        ...
        assert itemId.equals(itemId_) : itemId + "!=" + itemId_;
    ...
    private String creatItem(List<String> lessons) {
        ...
        JSONObject list = cn.vr168.interfacetest.inter.mizhu.web.item.List.of().list(Jigou.getInstance().getToken(), "1", "100");
